<template>
  <div class="min-h-screen transition-colors duration-300 bg-slate-900">
    <section class="max-w-5xl mx-auto px-4 py-12">
      <h1 class="text-4xl font-extrabold text-gray-100 mb-3 tracking-tight">
      ...
      <div v-else class="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div class="p-6 flex flex-col flex-1">
            ...
            <h2 class="text-2xl font-bold mb-2 text-white group-hover:text-blue-400 transition-colors duration-150">
              {{ post.title }}
            </h2>
